 ...
 */
public final class NamespaceAnalyzer extends BaseCompilerProcessor {
    /**
    ...
    private class Visitor extends AgentScriptBaseVisitor<Void> {
        ...
        private boolean namespaceNameMatchesSourcePath(Symbol namespaceName) {
            ...
            return relativeSourcePath.getName(lastIndex).toString().equals(namespaceParts[lastIndex] + DefaultCompiler
