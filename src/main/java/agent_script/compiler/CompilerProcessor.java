...
/**
 * Abstract implementation of {@link ICompilerProcessor}.
 */
public abstract class CompilerProcessor implements ICompilerProcessor {
    ...
    public CompilerProcessor(CompilerMessageReporter messageReporter) {
    ...
    protected NamespaceDefinition resolvedNamespaceDefinition(Symbol namespaceName) {
        Map<Symbol, NamespaceDefinition> namespaceDefinitions = namespaceBundle.getNamespaceDefinitions();
